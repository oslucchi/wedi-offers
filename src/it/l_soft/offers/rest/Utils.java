...
public class Utils {
	...
	public static int setLanguageId(String language)
	{
		if (language == null)
		{
			language = prop.getDefaultLanguage();
		}
...
//		Genson genson = new Genson();
	...
	public static String checkJsonAttribute(JsonObject jsonIn, String attribute)
	{
		String retVal = null;
		try
		{
	...
	public static String decode(String key, String tokenParm) 
	{
		return null;
	}
}